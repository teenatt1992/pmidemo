		...
		<div class="content-bottom" >
			<div class="col-md-5 con-btm-left">
				<div class="register" style="background-color:white;" >
						...
						<?php echo render($sidebar_second) ?>
						
					
					
				</div>
				<div class="shopping-chart">
					<?php echo render($postscript_third) ?>
					
					<a href="#" Style="float:right">More</a>
				</div>
				<div class="shopping-chart">
					<?php echo render($postscript_fourth) ?>
					<br><br>
					<a href="#" Style="float:right">More</a>
				</div>
			</div>
			<div class="col-md-7 con-btm-right">
				<div class="con-btm-grids">
					<div class="con-btm-l" >
						<div class="login-tab" style="background-color:white;">
						 <ul class="tabs" data-persist="true">
            <li><a href="#view1">Recently Visited</a></li>
            <li><a href="#view2">Recently Joined</a></li>
            
        </ul>
        <div class="tabcontents">
            <div id="view1">
               <?php echo render($header_second4) ?>
                
            </div>
            <div id="view2">
                 <?php echo render($header_first) ?>              
            </div>
						...
						<div class="fb-connect">
								<?php echo render($preface_third) ?>
						</div>
<div class="fb-connect">
								<?php echo render($preface_first) ?>
						</div>
<div class="fb-connect">
								<?php echo render($header_second30) ?>
						</div>
<div class="fb-connect">
								<?php echo render($header_second27) ?>
						</div>
						<div class="mail-list" style="background-color:gainsboro">
					</div>
...
<div class="sap_tabs"style="background-color:white;text-align:center;margin-left:9px;">	
                                                      <?php echo render($header_second) ?><br><br><br><br><br><br> <?php echo render($header_second1) ?><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                                                </div>
					</div>
					<div class="clearfix"></div>
				</div>
