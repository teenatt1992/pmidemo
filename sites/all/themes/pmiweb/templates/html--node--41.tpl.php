...
<tr><td style="width:10%;"><?php echo render($logos) ?></td><td style="background-color:gainsboro;width:90%;"><?php print render($user_first); ?></td></tr></table>
		...
		<div class="content-bottom"  style="background-color:white;">
			...
			<div class="col-md-71 con-btm-right"style="border:none;" >
				
					<div style="border:none;" >
					<div id="special"><h2>Members</h2><br><br><?php echo render($header_second11) ?><br></div>
					<h2>Board of Directors </h2><br><br><?php echo render($header_second12) ?><br>
					<h2>Past Directors </h2><br><br><?php echo render($header_second13) ?>
