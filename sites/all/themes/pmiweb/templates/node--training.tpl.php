...
<div class="content">
	<div class="container">
		...
		<div class="content-bottom"  >
			<div class="col-md-3 con-btm-left" style="background-color:white;"><br><br><h4>Users Attending</h4><br>
<?php if ($header_second14): ?>
  
    <?php print render($header_second14); ?>
 
<?php endif; ?><br><br><br>
				<?php echo render($header_second2) ?><br><br><br><br><br><br><br><br><br><br>
			</div>
...
<div class="shop-price">
									<p><?php print render($content['field_trainingimage']) ?></p>
<p><?php print render($content['field_traindate']) ?></p>
<p><?php print render($content['field_training_place']) ?></p>
<p><?php print $fields['field_eventplace']->content; ?></p>
								</div>
...
?> to participate in this training program.</pre></strong>
                ...
                <tr>
                  <td class="eventcontent"><?php print render($content['field_trai_reg']) ?></td>
                </tr>
...
<table width="100%" border="0" cellspacing="5" cellpadding="0">
                ...
                <tr>
                  <td class="eventcontent"><strong><?php print render($content['field_trainingdescription']) ?></strong>
                  </td>
                </tr>
...
<table width="100%" border="0" cellspacing="5" cellpadding="0">
                ...
                <tr>
                  <td class="eventcontent"><strong><?php print render($content['field_trainingdocuments']) ?></strong>
                  </td>
                </tr>
...
<table width="100%" border="0" cellspacing="5" cellpadding="0">
                ...
                <tr>
                  <td class="eventcontent"><strong><?php print render($content['field_trainingeventphotos']) ?></strong>
                  </td>
                </tr>
