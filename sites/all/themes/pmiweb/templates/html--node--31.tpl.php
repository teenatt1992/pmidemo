...
<tr><td style="width:10%;"><?php echo render($logos) ?></td><td style="background-color:gainsboro;width:90%;"><?php print render($user_first); ?></td></tr></table>
		...
		<div class="content-bottom"  style="background-color:gainsboro;">
			
			<div class="col-md-71 con-btm-right">
				
					<div class="shopping-chart" style="background-color:gainsboro;">
					<?php echo render($header_second6) ?>
