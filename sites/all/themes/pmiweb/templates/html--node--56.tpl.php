...
<tr><td style="width:10%;"><?php echo render($logos) ?></td><td style="background-color:gainsboro;width:90%;"><?php print render($user_first); ?></td></tr></table>
		...
		<div class="content-bottom" >
			<div class="col-md-3 con-btm-left" style="background-color:white;"><br><br>
...
<nav id="menu1_box">
  ...
  <ul class="menu1">
    ...
    <li> <a href="#"><a href="http://localhost/pminew/?q=node/56">Current Events</a></a>
...
<br>
<br><br><h4>Registration Date</h4><br>
    ...
    <?php $x= render($header_second22);
echo $x; ?>

 <?php if (empty($x)){echo "Currently no events";}?>
